...
Item {
    ...
    property int fanValue: 50
    property int tempLeftValue: 50
    property int tempRightValue: 50
    ...
    Item {
        ...
        Image {
            ...
            Image {
                anchors.fill: parent
                anchors.right: parent.right; anchors.rightMargin: parent.width * fanValue / 100
