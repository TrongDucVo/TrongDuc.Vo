    ...
    Item {
                ...
                Rectangle{
                    ...
                    MouseArea{
                        ...
                        onClicked: {
                            ...
                            if(textin1.length>=13)
                            {

                                textin1.text = str.substring(0,str.length - 1)
                            }

                            if(textin1.length==3 || textin1.length==7)
                            {

                                textin1.text = str.substring(0,str.length) + "-"
                            }
                            if(textin1.length<12)
                            {
        ...
        Rectangle{
            ...
            TextInput{
                ...
                color: "white"
                focus : true
                anchors.right: input1.right
                persistentSelection: true


            // TextInput.effectiveHorizontalAlignment:  TextInput.AlignRight
